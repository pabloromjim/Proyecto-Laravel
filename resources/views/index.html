...
<body class="bg-[rgb(39,39,39)] text-white work-sans leading-normal text-base tracking-normal">
    ...
    <section class="w-full mx-auto bg-nordic-gray-light flex pt-12 md:pt-0 md:items-center bg-cover bg-right" style=" height: 32rem; background-image: url('https://s2.gaming-cdn.com/img/products/2587/pcover/2587.jpg?v=1676979802');">
        ...
        <div class="container mx-auto">
            ...
            <div class="flex flex-col w-full lg:w-1/2 justify-center items-start  px-6 tracking-wide">
                <h1 class="text-black text-2xl my-4">Atomic Huevo</h1>
                <a class="text-xl inline-block text-black no-underline border-b border-gray-600 leading-relaxed hover:text-[#ff5400] hover:border-black" href="#">Ver</a>
    ...
    <section class="bg-[rgb(39,39,39)] text-white work-sans py-8">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="https://s3.gaming-cdn.com/images/products/2615/616x353/mario-kart-8-deluxe-switch-switch-juego-nintendo-eshop-europe-cover.jpg?v=1649856900">
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">Mario Kakas</p>
                        <!-- carrito -->
                    ...
                    <p class="pt-1 text-[#ff5400]">£9.99</p>
                </a>
            </div>
    ...
    <!-- suuusucribete -->
    <div class="bg-[rgb(39,39,39)] flex flex-col p-[30px];">
        <div class="max-w-[1200px] self-center w-full flex flex-col justify-center items-center text-center">
            <div class="flex items-center flex-col mb-5 ">
                 <div class="w-10 h-10 flex-[0_0_40px] mb-5"> <!--   iconito -->
                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
                        ...
                        <path class="cls-1" d="M125,177.86a5,5,0,0,1-4.74-3.42L96,101.76,27.64,77.57a5,5,0,0,1,.2-9.49L169.22,24.53a5,5,0,0,1,6.23,6.3L129.76,174.37a5,5,0,0,1-4.73,3.49ZM45.23,73.19l56.44,20a5,5,0,0,1,3.07,3.13l20.15,60.44L163,36.9Z"></path>
                        <path class="cls-1" d="M100,102.84a4.94,4.94,0,0,1-3.59-1.52,5,5,0,0,1,.11-7.07L131.86,60a5,5,0,0,1,7,7.18l-35.35,34.26A5,5,0,0,1,100,102.84Z"></path>
                        <path class="cls-1" d="M75,175.69a5,5,0,0,1-3.19-8.85l25-20.69a5,5,0,0,1,6.38,7.7l-25,20.69A5,5,0,0,1,75,175.69Z"></path>
                        <path class="cls-1" d="M29.31,175.69a5,5,0,0,1-3.53-8.54l45.68-45.69a5,5,0,0,1,7.08,7.08L32.85,174.22A5,5,0,0,1,29.31,175.69Z"></path>
                        <path class="cls-1" d="M29.31,130a5,5,0,0,1-3.85-8.19l20.69-25a5,5,0,0,1,7.7,6.38l-20.69,25A5,5,0,0,1,29.31,130Z"></path>
                    </svg></div>
                <div class="lines">
                    <h3>¡No te pierdas ninguna huevo de oferta</h3>
                    <span>¡Y sé el primero en recibir nuestras ofertas privadas, newsletters y promociones de la
                        semana!</span>
                </div>
            </div>
            <a href="https://www.instant-gaming.com/es/mi-cuenta/#user-profile-settings-communication" class="font-bold text-[17px] text-white inline-flex items-center justify-center h-14 box-border cursor-pointer text-center whitespace-normal px-[30px] py-0 rounded-lg border-0 bg-[#ff5400]">
                ¡Suscríbete!
            </a>
        </div>
    </div>
